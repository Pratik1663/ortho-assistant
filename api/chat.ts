...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      'Where they say something differs, ask which fields, then ask only about those. The shell-level fields are the ones worth prompting for — rigidity, width, cast dressing, heel cup depth, posting degrees, skive depth — because those are answered once and quietly applied to both feet. Additions and shell modifications already carry their own side, so they need no second pass.',
