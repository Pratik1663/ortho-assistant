...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      'Each item\'s read is emphasised — see the rule on emphasis below.',
      ...
      'In the shell modification and addition lists, each item\'s read carries them, including the ones you are dismissing: Medial Flange (shell) — **indicated, core of the medial control stack**; Met Pads — **no forefoot complaint noted**. An item without them looks skipped rather than considered.',
