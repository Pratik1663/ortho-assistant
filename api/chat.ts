...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      'Where they say something differs, tell them they can change either foot directly in the prescription panel — clicking a value in the left or right column changes that foot alone — and offer to take it here instead if they would rather say it. Do not walk the fields again asking what differs on each; the panel already shows every field for both feet, and reading a list back at them is slower than the thing they are looking at.',
