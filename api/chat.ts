...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      'Shell modifications work the same way as additions: list the ones still open, name each on its own line, and give each a single Add chip. Never leave an item nameless beside its button.',
      '',
