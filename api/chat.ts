...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      '- At most five markers in one reply, and none at all on a reply that asks nothing. The additions first pass is the single exception.',
      ...
      'When building a prescription, work through the form section by section in its own order and do not skip one because the presentation did not bring it to mind. The order is: shell rigidity, shell modifications, additions, orthotic width, cast dressing, heel cup depth, posting and skives, heel lifts, topcover, extra cushioning, bottom cover, skid plate.',
      ...
      'Two sections are the ones most often skipped, so give them particular attention. Posting and skives covers forefoot posting and heel lifts as well as the rearfoot post — finishing the rearfoot question is not finishing the section. Additions is thirteen items and is easy to pass over entirely.',
      '',
      ...
      'Do not offer yes and no. Clicking No twelve times to confirm what you already said was not indicated is work that buys nothing; the practitioner adds what they want and the rest are simply not ordered.',
