...
function buildWorkflowBlock(
  ...
  if (action === 'consultation') {
    ...
    lines.push(
      ...
      'Ask one value per marker. "Intrinsic or extrinsic, and how many degrees" is two questions sharing a line — split them, one with options and one with an input, so each answer lands on its own field.',
      '',
